# Descripción
Se propone un curso introductorio a R, el mismo se apoyará en el GUI RStudio v1.1.456 y en el conjunto de paquetes tales como ggplot2, plotly, dplyr, rmarkdown, entre otros.
Dicho curso será dictado dentro del marco de los Curso de actualización 2019 ofrecidos por del Dpto. de Informática de la Facultad de 
